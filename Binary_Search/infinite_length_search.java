...
//Given an array of infinite length and we need to search for an element
public class infinite_length_search {
    ...
    public static void main(String[] args){
        ...
        System.out.println("Element Found at index "+ binary_search(arr, target, start, end));
